...
:::::: system-window
::: system-titlebar
[[Latest Projects](projects.html)]{.system-title}
:::
...
:::::: system-content
::: {.bio-slider-container style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px dotted #000;"}
<label for="bio-slider" style="display: block; font-weight: bold; margin-bottom: 0.5rem;"> Detail level: [Reasonable]{#bio-level-label} </label> <input type="range" id="bio-slider" min="1" max="3" value="2" style="width: 100%; cursor: pointer;">
:::

:::: {#bio-content}
In 2022, I was at Northwestern University's [Technology and Social Behavior](https://tsb.northwestern.edu/) CS + Communication joint program, working as a research assistant at the [SONIC](http://sonic.northwestern.edu/) lab.[ There, I used social network analysis to investigate how human-AI teams interact and communicate.]{.bio-standard-up}[ I was also a somewhat active participant in open science initiatives, including replication games and massive collaborative research projects.]{.bio-detailed-up}

Around 2019, I was a research assistant at the [University of Bergen](https://www.uib.no/en/persons/Vsevolod.Suschevskiy), working with Mohammad Khalil at [SLATE](https://slate.uib.no/)[.]{.bio-brief-only}[, where I helped create CERES—a virtual lab designed to study course recommendation systems. We launched a pilot experiment with real students and published a [paper](https://www.researchgate.net/publication/350874550_Creating_a_Course_Recommendation_System_for_Exchange_Students) detailing the platform's initial iteration.]{.bio-standard-up}[ During this time, I also analyzed classroom interventions using mixed models and structural equation modeling.]{.bio-detailed-up}

In 2020 I studied [Human-Computer Interaction](https://spb.hse.ru/en/ma/computer/) at HSE University under the supervision of [Ilya Musabirov](https://dotsbyname.quarto.pub/imusabirov/)[.]{.bio-brief-only}[, where my thesis research explored how self-nudging affects personal motivation.]{.bio-standard-only}[, where my thesis research—funded by a grant from Toloka—explored how self-nudging affects personal motivation. I run experiments with hundreds of crowdworkers.]{.bio-detailed-up}
...
::::: system-window
::: system-titlebar
[<a href="https://scholar.google.com/citations?hl=en&user=TycFXMIAAAAJ&view_op=list_works&sortby=pubdate" target="_blank">Latest Publications</a>]{.system-title}
:::
...
:::: system-content
Please call me [Seva]{onclick="let p = document.getElementById('name-phonetics'); p.style.display = (p.style.display === 'none') ? 'inline' : 'none';" style="cursor: pointer; border-bottom: 1px dotted currentColor;" title="Click for pronunciation"}[ <br> (It is Vsevolod (ˈfsʲevələt), but it is ok to call me Seva (sʲeva))]{#name-phonetics style="display: none; font-size: 0.85em; background: rgba(128,128,128,0.15); padding: 2px 6px; border-radius: 4px; margin: 0 6px;"}, and here is my [CV](cv/cv_page.html).

::: system-pills
<a class="system-pill" href="projects.html">Projects</a> <a class="system-pill" href="teaching.html">Teaching</a> <a class="system-pill" href="cv/cv_page.html">CV</a> <a class="system-pill" href="https://github.com/vvseva" target="_blank">GitHub</a> <a class="system-pill" href="https://www.linkedin.com/in/vvsuschevskiy/" target="_blank">LinkedIn</a> <a class="system-pill" href="https://scholar.google.com/citations?view_op=view_citation&hl=en&user=TycFXMIAAAAJ&citation_for_view=TycFXMIAAAAJ:" target="_blank">Scholar</a>
:::
::::
::::::
::::::::::
...
[💬]{.chat-icon} [Chat with us!]{.chat-text}

</button>

:::::: {.chat-popup style="display: none;"}
::: system-titlebar
[🤖 AI Support]{.system-title} <button class="chat-close" onclick="document.querySelector('.chat-popup').style.display = 'none'; document.querySelector('.chat-button').style.display = 'flex';">✕</button>
:::
...
<p><strong>Email me at:</strong><br> <a href="mailto:vsevolod.suschevskiy@liu.se">vsevolod.suschevskiy\@liu.se</a></p>
:::
::::
::::::
:::::::
