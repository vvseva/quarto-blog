...
cat('</ul>\n')
cat(sprintf(
  '<p style="font-size:11px; margin-top:0.5rem;"><a href="%s" target="_blank">\u2192 Full list on Google Scholar</a></p>\n',
  "https://scholar.google.com/citations?hl=en&user=TycFXMIAAAAJ&view_op=list_works&sortby=pubdate"
))
```
</div>
:::
