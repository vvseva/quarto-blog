...
::: {.system-window}
<div class="system-titlebar"><span class="system-title"><a href="https://scholar.google.com/citations?hl=en&user=TycFXMIAAAAJ&view_op=list_works&sortby=pubdate" target="_blank">Publications</a></span></div>
<div class="system-content">
<ul class="system-publications-list">
  <li>
    <span class="pub-title"><a href="https://www.researchgate.net/publication/350874550_Creating_a_Course_Recommendation_System_for_Exchange_Students" target="_blank">Creating a Course Recommendation System for Exchange Students</a></span>
    <span class="pub-meta">Suschevskiy V., Khalil M. — LAK '21 Companion (2021)</span>
  </li>
  <li>
    <span class="pub-title">Analyzing Classroom Intervention with Mixed Models and SEMs</span>
    <span class="pub-meta">Suschevskiy V. et al. — Journal of Internet and Higher Education (submitted)</span>
  </li>
  <li>
    <span class="pub-title">Self-Nudges on Motivation in Crowdsourcing Platforms</span>
    <span class="pub-meta">Suschevskiy V., Musabirov I. — Toloka Research Grant (2022)</span>
  </li>
</ul>
<p style="font-size:11px; margin-top:0.5rem;"><a href="https://scholar.google.com/citations?hl=en&user=TycFXMIAAAAJ&view_op=list_works&sortby=pubdate" target="_blank">→ Full list on Google Scholar</a></p>
</div>
:::
