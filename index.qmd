...
<div class="bio-slider-container" style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px dotted #000;">
  <label for="bio-slider" style="display: block; font-weight: bold; margin-bottom: 0.5rem;">
    Detail level: <span id="bio-level-label">Detailed</span>
  </label>
  <input type="range" id="bio-slider" min="1" max="3" value="3" style="width: 100%; cursor: pointer;">
</div>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const text1 = document.getElementById("bio-text-1");
  const text2 = document.getElementById("bio-text-2");
  const text3 = document.getElementById("bio-text-3");
  ...
  updateBio(); // Initialize state on load
});
</script>
