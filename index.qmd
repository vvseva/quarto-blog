...
In 2025 I started a PhD at Linköping University, Sweden where I work with [Miriah Meyer](https://miriah.github.io/) on interactive visualization tools for computational sociology. We will try to explain segregation model to normal people (non experts).
</div>
:::
...
Before that, I worked as a research assistant at [Universitetet i Bergen](https://www.uib.no/en/persons/Vsevolod.Suschevskiy). Together with Mohammad Khalil at [SLATE](https://slate.uib.no/), we created CERES – a virtual lab to study course recommendation system. We even published a [paper](https://www.researchgate.net/publication/350874550_Creating_a_Course_Recommendation_System_for_Exchange_Students) about the first iteration, but we also managed to launch and analyze a pilot experiment with real students. Furthermore, I worked on analyzing classroom intervention with mixed models and SEMs. *(sumbitted to a* Journal of Internet and Higher Education*)*

Also, I was a [HCI](https://spb.hse.ru/en/ma/computer/) student at HSE University. I worked with [Ilya Musabirov](https://dotsbyname.quarto.pub/imusabirov/), and my thesis received a research grant from Toloka to explore the effect of self nudges on motivation.
